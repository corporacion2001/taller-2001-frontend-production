...
const tiposPlaca = [
  ...
  { value: "TAP", label: "TAP-AEROPUERTO INTERNACIONAL JUAN SANTAMARIA" },
  { value: "352", label: "352-AGENCIA DE PROTECCION DE DATOS DE LOS HABITANTES" },
  ...
  { value: "316", label: "316-ASOCIACION DE CONSERVACION Y DESARROLLO FORESTAL DE TALAMANCA" },
  { value: "297", label: "297-AUTORIDAD REGULADORA DE LOS SERVICIOS PUBLICOS" },
  ...
  { value: "325", label: "325-CENTRO COSTARRICENSE DE PRODUCCION CINEMATOGRAFICA" },
  { value: "327", label: "327-CENTRO CULTURAL E HISTORICO JOSE FIGUERES FERRER" },
  ...
  { value: "298", label: "298-COLEGIO UNIVERSITARIO PARA EL RIESGO Y EL DESARROLLO DEL TROPICO" },
  ...
  { value: "057", label: "057-COMISION NACIONAL DE PRESTAMOS PARA LA EDUCACION" },
  { value: "322", label: "322-COMISION NACIONAL DE PREVENCION DE RIESGOS Y ATENCION EMERGENCIAS" },
  { value: "351", label: "351-COMISION PARA EL ORDENAMIENTO Y MANEJO DE LA CUENCA DEL RIO REVENTAZON" },
  { value: "353", label: "353-COMISIÓN NACIONAL PARA LA GESTION DE LA BIODIVERSIDAD (CONAGEBIO)" },
  ...
  { value: "328", label: "328-CONSEJO NACIONAL DE LA POLITICA PUBLICA DE LA PERSONA JOVEN" },
  { value: "240", label: "240-CONSEJO NACIONAL DE PERSONAS CON DISCAPACIDAD (CONAPDIS)" },
  ...
  { value: "D H", label: "D H-DEFENSORIA DE LOS HABITANTES DE LA REPUBLICA" },
  ...
  { value: "101", label: "101-EMPRESA DE SERVICIOS PUBLICOS DE HEREDIA" },
  ...
  { value: "355", label: "355-FONDO DE NACIONAL DE FINANCIAMIENTO FORESTAL (FONAFIFO)" },
  { value: "350", label: "350-FONDO NACIONAL DE BECAS" },
  { value: "329", label: "329-FUNDACION AYUDANOS PARA AYUDAR (CENTRO COSTARRICENSE DE LA CIENCIA Y LA CULTURA)" },
  ...
  { value: "INC", label: "INC-INSTITUTO COSTARRICENES DE PESCA Y ACUACULTURA" },
  { value: "003", label: "003-INSTITUTO COSTARRICENSE CONTRA EL CANCER" },
  { value: "102", label: "102-INSTITUTO COSTARRICENSE DE ACUEDUCTOS Y ALCATARILLADOS" },
  { value: "103", label: "103-INSTITUTO COSTARRICENSE DE ELECTRICIDAD" },
  { value: "256", label: "256-INSTITUTO COSTARRICENSE DE INVESTIGACION Y ENSEÑANZA EN NUTRICION Y SALUD" },
  { value: "313", label: "313-INSTITUTO COSTARRICENSE DE PESCA Y ACUACULTURA" },
  { value: "263", label: "263-INSTITUTO DE DESARROLLO AGRARIO" },
  { value: "059", label: "059-INSTITUTO DE FOMENTO Y ASESORIA MUNICIPAL" },
  { value: "104", label: "104-INSTITUTO DE PUERTOS DEL PACIFICO" },
  { value: "IAG", label: "IAG-INSTITUTO GEODESICO AMERICANO" },
  { value: "113", label: "113-INSTITUTO NACIONAL DE ESTADISTICA Y CENSOS" },
  { value: "060", label: "060-INSTITUTO NACIONAL DE FOMENTO" },
  { value: "346", label: "346-INSTITUTO NACIONAL DE INNOVACION Y TRANSFERENCIA EN TECNOLOGIA AGROPECUARIA" },
  { value: "061", label: "061-INSTITUTO NACIONAL DE SEGUROS" },
  { value: "105", label: "105-INSTITUTO NACIONAL DE VIVIENDA Y URBANISMO" },
  { value: "109", label: "109-JUN.ADM.PUER.DES.ECON. VERT.ATLANTICA" },
  { value: "268", label: "268-JUNTA ADM. DIR. NAC. DE COMUNICACIONES S" },
  { value: "331", label: "331-JUNTA ADMINISTRATIVA ARCHIVO NACIONAL" },
  { value: "108", label: "108-JUNTA ADMINISTRATIVA DE SERVICIOS ELECTRICOS DE CARTAGO" },
  { value: "332", label: "332-JUNTA ADMINISTRATIVA DEL MUSEO HISTORICO JUAN SANTAMARIA" },
  { value: "310", label: "310-JUNTA ADMINISTRATIVA REGISTRO NACIONAL" },
  { value: "333", label: "333-JUNTA ADMINISTRATIVA TEATRO MELICO SALAZAR" },
  { value: "315", label: "315-JUNTA ADMINISTRATIVA TEATRO NACIONAL" },
  { value: "330", label: "330-JUNTA ADMINISTRATIVA TEATRO NACIONAL" },
  { value: "273", label: "273-JUNTA DE PEN. Y JUB. MAGISTERIO NACIONAL" },
  ...
  { value: "336", label: "336-MUSEO DE ARTE Y DISEÑO CONTEMPORANEO" },
  ...
  { value: "112", label: "112-PROGRAMA INTEGRAL DE MERCADEO AGROPECUARIO (PIMA)" },
  { value: "PB", label: "PB-PUNTARENAS BUS" },
  { value: "PP", label: "PP-PUNTARENAS PUBLICO" },
  { value: "106", label: "106-RADIOGRAFICA COSTARRICENSE S.A." },
  { value: "308", label: "308-REFINADORA COSTARRICENSE DE PETROLEO (RECOPE)" },
  ...
  { value: "347", label: "347-SISTEMA NACIONAL DE AREAS DE CONSERVACION" },
  { value: "338", label: "338-SISTEMA NACIONAL DE RADIO Y TELEVISION S.A. (SINART S.A.)" },
  { value: "345", label: "345-SUPERINTENDENCIA DE TELECOMUNICACIONES (SUTEL)" },
  ...
  { value: "307", label: "307-UNIVERSIDAD ADVENTISTA DE CENTRO AMERICA" },
